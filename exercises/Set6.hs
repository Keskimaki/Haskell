...
simplify (RationalNumber n d) = RationalNumber (div n i) (div d i)
  where i = gcd n d
...
instance Num RationalNumber where
  ...
  abs (RationalNumber n d) = if n < 0 then RationalNumber (-n) d else RationalNumber n d
  signum (RationalNumber n d) | n == 0 = 0
                              | n > 0 = 1
                              | otherwise = -1
